   ...
   <div class="card-body pb-0">
      <form action="{{ route('category.store') }}" method="post">
         ...
         <div class="form-group">
            ...
            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Enter the Category Title">
            @error('title')
         ...
         <div class="form-group">
            ...
            <input name="category_img" type="text" class="form-control @error('category_img') is-invalid @enderror" id="blog_image" value="" readonly>
            @error('category_img')
               <div style="text-align: center; margin-top: 10px;" class="alert-danger">{{ $message }}</div>
            @enderror
