                ...
                <div class="burger-container d-flex">
                    <div class="container-left">
                        <ul class="left-navbar">
                            <li class="left-item">
                                <a class="left-link" href="#">Home</a>
                            </li>
                            <li class="left-item">
                                <a class="left-link" href="#">Menu</a>
                            </li>
                            <li class="left-item">
                                <a class="left-link"  href="#">Blogs</a>
                            </li>
                            <li class="left-item">
                                <a class="left-link" href="#">About</a>
                            </li>
                            <li class="left-item">
                                <a class="left-link" href="#">Contact</a>
                            </li>
                        </ul>
                    </div>
